...
public class visit_2_getter_setter implements Serializable {
    private int id_sp;
    ...
    public visit_2_getter_setter(String ten_sp, String gia_sp, String hinhanh_sp) {
        this.ten_sp = ten_sp;
        this.gia_sp = gia_sp;
        this.hinhanh_sp = hinhanh_sp;
    }

    public visit_2_getter_setter() {
    }
